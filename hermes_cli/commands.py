...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agent", "Route this chat to a different agent profile (or create new ones)", "Session",
               aliases=("agents",), args_hint="[use|clear|status|create|delete|list|webhook] ..."),
