...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agent", "Bind this chat to an agent profile", "Session",
               args_hint="<use|clear|status|webhook|list|create|delete> [profile]", gateway_only=True,
               busy_policy="dispatch"),
    ...
    CommandDef("room", "Manage multi-agent hosted rooms (list, show, create, add, remove, disband)",
               "Tools & Skills", args_hint="[subcommand]", gateway_only=True,
               subcommands=("list", "show", "create", "add", "remove", "disband"),
               busy_policy="dispatch"),
