...
def read_profile_meta(profile_dir: Path) -> dict:
    ...
    Returns ``{"description": "", "description_auto": False, "template":
    False, "display_name": ""}`` when the file is missing or unreadable.
    Never raises — a corrupt profile.yaml on an unrelated profile must not
