    ...
    if profiles_root.is_dir():
        ...
        for entry in entries:
            ...
            profiles.append({
                ...
                "template": _safe(lambda entry=entry_path: profiles_mod.read_profile_meta(entry).get("template", False), False),
...
_BUILTIN_DASHBOARD_THEMES = [
    ...
    {"name": "google",    "label": "Google",         "description": "Light mode — google.com homepage: white canvas, Google blue accents"},
]
