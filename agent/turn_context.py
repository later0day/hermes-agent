...
def build_turn_context(
    ...
    *,
    ...
    # (e.g. api_server's /p/<profile>/… prefix) the turn log otherwise
    # only shows model/provider, making it impossible to confirm the
    # request entered the intended profile scope. Reuse the same
    # override-aware, session-db-fallback resolution as system_prompt so
    # threads that lost the HERMES_HOME ContextVar don't misreport as
    # "default" (#86313 class).
    try:
