  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        >
          ...
          >
            ...
            <header className="p-5 pb-3 border-b border-border">
              ...
              >
                {t.dashboard?.mcpAddServer || "Add MCP server"}
              </h2>
            </header>
                ...
                <>
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="mcp-env">
                      {t.dashboard?.uiMcpEnvironment || "Environment (KEY=VALUE per line)"}
                    </Label>
                    <textarea
                      id="mcp-env"
      ...
      {installEntry && (
        ...
        >
          ...
          >
            ...
            <div className="p-5 grid gap-4">
              <p className="text-xs text-muted-foreground">
                {t.dashboard?.uithisMcpRequiresTheFollowingV || "This MCP requires the following values to be configured."}
              </p>
        ...
        {servers.length === 0 && (
          <Card>
            <CardContent className="py-8 text-center text-sm text-muted-foreground">
              {t.dashboard?.uinoMcpServersConfigured || "No MCP servers configured."}
            </CardContent>
          </Card>
        )}
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {!server.enabled && <Badge tone="outline">{t.dashboard?.uidisabled || "disabled"}</Badge>}
                  </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xs text-muted-foreground">
          {t.dashboard?.uibrowseNousApprovedMcpServers || "Browse Nous-approved MCP servers and install them with one click."}
        </p>

        {catalog.length === 0 && (
          <Card>
            <CardContent className="py-8 text-center text-sm text-muted-foreground">
              {t.dashboard?.uinoCatalogEntriesAvailable || "No catalog entries available."}
            </CardContent>
          </Card>
        )}
              ...
              <CardContent className="flex items-start gap-4 py-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    {entry.installed && <Badge tone="success">{t.dashboard?.mcpInstalled || "Installed"}</Badge>}
