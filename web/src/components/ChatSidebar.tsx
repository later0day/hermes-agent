          ...
          <div className="min-w-0 flex-1">
            ...
            {error && (
              <Button
                ...
                prefix={<RefreshCw />}
              >
                {/* Upstream renamed the feed from "tools" to "events" when it
                    added reconnect backoff; keep the i18n lookup and take the
                    new wording as the fallback. */}
                {t.dashboard?.sidebarReconnect || "reconnect events feed"}
              </Button>
            )}
          </div>
        </Card>
