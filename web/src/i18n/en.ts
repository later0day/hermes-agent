...
export const en: Translations = {
  ...
  "oauth": {
    ...
    "disconnectConfirmDescription": "This will remove the stored OAuth tokens for {name}. You will need to re-authenticate to use it again.",
    "failedToStartLogin": "Failed to start login",
    "connectedMessage": "{name} connected",
    "disconnectedMessage": "{name} disconnected",
  ...
  "dashboard": {
    ...
    "uiConfigurePlatform": "Configure {name}",
    "uiLeaveBlankToKeep": "•••••• (set — leave blank to keep)",
    "uiSaveAndEnable": "Save & enable",
    "uiSetUpWithQr": "Set up with QR",
    "uiTelegramUserIdPlaceholder": "Telegram user ID",
    "uiSaveAndRestart": "Save and restart",
