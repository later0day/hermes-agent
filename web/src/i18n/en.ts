...
export const en: Translations = {
  ...
  "pairing": {
    ...
    "mAgo": "{count}m ago",
    "revokeDescUser": "\"{name}\" will lose access. This cannot be undone.",
    "revoked": "Revoked: \"{name}\"",
    "pendingRequests": "Pending requests",
    "approveLabel": "Approve",
    "loadFailed": "Failed to load pairing requests",
    "approvedUsers": "Approved users",
    "clearedCount": "Cleared {count} pending request(s)",
    "noApproved": "No approved users",
    "revokeDescGeneric": "This user will lose access. This cannot be undone.",
    "error": "Error",
  ...
  "channels": {
    ...
    "telegramAddOneHint": "Add at least one Telegram user ID.",
    "cancel": "Cancel",
    "gatewayRestartManual": "Gateway restart failed — restart manually",
    "notRunningNote": "The gateway is not running. Configure channels here, then start the gateway with",
    "gatewayRestartFailed": "Gateway restart failed:",
    "telegramSavedRestartFailedDetail": "Telegram saved; gateway restart failed:",
    "savedSuccess": "saved",
    "restartGateway": "Restart gateway",
    "telegramOwnerDetected": "owner detected",
    "telegramWaitRetry": "Still waiting for Telegram. Retrying after:",
    "configTitle": "Configure {name}",
    "setupGuide": "Setup guide",
    "telegramUseOwnBot": "Use your own Telegram bot",
    "botFatherGuide": "BotFather guide",
    "telegramChooseConnect": "Choose how to connect your Telegram bot",
    "telegramChooseConnectHint": "Both options connect a bot you control and save its credentials only to this Hermes installation.",
    "testSuccess": "Test",
    "summaryNote": "{configured} of {total} channels configured.",
    "telegramAddOne": "Add at least one allowed Telegram user ID.",
    "saving": "Saving…",
    "configure": "Configure",
    "telegramSaveRestart": "Save and restart",
    "telegramSavedRestartFailed": "Telegram saved; gateway restart failed",
    "telegramIdNumeric": "Allowed Telegram user IDs must be numeric.",
    "test": "Test",
    "telegramReady": "Ready",
    "gatewayRestarting": "Restarting…",
    "telegramUserIdPlaceholder": "Telegram user ID",
    "restartNote": "Changes are saved. Restart the gateway for them to take effect.",
    "saveFailed": "Failed to save:",
    "saveEnable": "Save & enable",
    "passwordPlaceholder": "•••••• (set — leave blank to keep)",
    "saveEmpty": "Nothing to save — fill in at least one field.",
    "enableAria": "Enable",
    "error": "Error",
    "telegramWaiting": "waiting",
  ...
  dashboard: {
    ...
    cronPlaceholderUrl: "https://api.example.com/v1",
    cronPlaceholderScript: "relative/path/in/scripts",
    cronPlaceholderProject: "/absolute/project/path",
    cronPlaceholderJobIds: "one job id per line",
    pbPlaceholderName: "coder",
    pbPlaceholderDesc: "What this agent profile is for",
    pbPlaceholderFilterModels: "Filter models…",
    pbPlaceholderSearchHub: "Search the hub (e.g. linear, hyperliquid)…",
    pbPlaceholderServerName: "Server name",
    pbPlaceholderMcpUrl: "URL (https://…/mcp)",
    pbPlaceholderCommand: "Command (e.g. npx)",
    pbPlaceholderArgs: "Args (space-separated)",
    sessionsRenameAria: "Rename session",
    sessionsRenameTitle: "Rename session",
    sessionsExportAria: "Export session",
    sessionsExportTitle: "Export session JSON",
    sessionsSaveTitleAria: "Save title",
    sessionsSaveTitleTitle: "Save title",
    sessionsCancelRenameAria: "Cancel rename",
    sessionsCancelRenameTitle: "Cancel rename",
    uiRemoveMcpServer: "Remove MCP server",
    uiTestConnection: "Test connection",
    uiMcpEnvironment: "Environment (KEY=VALUE per line)",
    uiEndpoint: "Endpoint:",
    uiChannelId: "Channel ID",
    uiModelOverride: "Model Override",
    uiProviderOverride: "Provider Override",
    uiSystemPromptOverride: "System Prompt Override",
    uiSystemPromptPlaceholder: "Override the agent's identity for this channel...",
    uiSkillName: "Name",
    uiSkillCategory: "Category (optional)",
    uiExpensiveModelWarning: "Expensive Model Warning",
    uiResetAuxiliaryModels: "Reset auxiliary models",
    uiConfigureMoaPresets: "Configure Mixture of Agents presets",
    uiSetDefault: "Set default",
    uiReferenceModels: "Reference models",
    uiChangeModel: "Change",
    uiAddReferenceModel: "Add reference model",
    uiAggregator: "Aggregator",
    uiSelectMoaModel: "Select MoA Model",
    uiSetMainModel: "Set Main Model",
    uiRestoreBackupsPath: "Restore from backups path",
    uiCopy: "Copy",
    uiWebhookDescPlaceholder: "What this webhook does (optional)",
    uiWebhookPromptPlaceholder: "Instructions for the agent when this webhook fires (optional)",
    uiFilterPlaceholder: "Filter providers and models…",
    uiSearchSessionsPlaceholder: "Search sessions…",
    uiSearchSkillsHubPlaceholder: "Search the skill hub (GitHub, official, community)…",
    uiSwitchModel: "Switch model?",
    uiCopyMarkdown: "Copy last assistant response as raw markdown",
    uiStoredHashPrefix: "Stored hash prefix, not the pairing code",
    uiDeleteSkill: "Delete skill",
    uiRestoreBackup: "Restore full Hermes backup?",
    uiUpdateHermes: "Update Hermes?",
    uiResetMemory: "Reset memory",
    uiRemoveCredential: "Remove credential",
    uiPruneCheckpoints: "Prune checkpoints",
    uiRemoveShellHook: "Remove shell hook",
  },
};
