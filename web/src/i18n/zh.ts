...
export const zh: Translations = {
  ...
  sessions: {
    ...
    searchGlobalPlaceholder: "搜索会话…",
    searchNoRecent: "暂无最近会话",
  ...
  rooms: {
    title: "托管房间",
    description:
      "多智能体托管房间的只读观察面板——成员、authority、驱动状态与追加式事件日志。可在聊天中用 /room 创建或解散。",
    empty: "暂无托管房间。可在聊天中用 /room create 创建。",
    showDisbanded: "显示已解散",
    members: "成员",
    revision: "修订",
    latestSeq: "日志 seq",
    authorityEpoch: "authority epoch",
    authorityGateway: "authority 网关",
    created: "创建于",
    updated: "更新于",
    disbanded: "已解散",
    driver: "驱动",
    ...
    // ── 邮箱 ──
    mailbox: "邮箱",
    newMessages: "{count} 条新",
    noMessages: "暂无消息。",
    markAllRead: "全部已读",
    clearMailbox: "清除",

    // ── 事件日志过滤 ──
    filterCoordinator: "协调者",
    filterTeammate: "队友",
    filterObserver: "观察者",
    filterUser: "用户",
    filterSystem: "系统",
    ...
    filterMessage: "消息",
    filterTurn: "回合",
    noEventsMatchingFilter: "无匹配过滤条件的事件。",

    // ── 观察者监控 ──
    observerMonitor: "观察者监控",
    state: "状态",
    rulesChecked: "已检查规则",
    violations: "违规",
    heartbeat: "心跳",
    ...
    secondsAgo: "{n}秒前",
    never: "从未",
    noObserver: "该房间未配置观察者。",
    observerError: "加载观察者失败。",

    // ── 协议消息类型标签 ──
    kindTaskAssign: "分配",
    kindTaskCancel: "取消",
    kindPlanSubmit: "计划",
    kindResultSynthesize: "汇总",
    kindResultReport: "报告",
    kindStatusReport: "状态",
    kindClarificationRequest: "澄清",
    kindActivityDigest: "摘要",
    kindHeartbeat: "心跳",
    kindRuleViolation: "违规",
    kindShutdown: "关闭",
    kindPermission: "权限",
    kindPlan: "计划",
    peerGrants: "对等授权",
    noPeerGrants: "无对等路由配置。",
    grantStatus: "状态",
    grantReady: "就绪",
    grantUnavailable: "不可用",
    grantNeedsReauth: "需重新授权",
    replicationHealth: "副本健康",
    healthy: "健康",
    unhealthy: "异常",
    peersReady: "{ready}/{total} 对等就绪",
    policyTrace: "策略追踪",
    noPolicyTrace: "无策略追踪数据。",
    policyEvents: "事件",
    policyWatermarks: "水位",
    policyThroughSeq: "已通过序号",
    linkage: "房间关联",
    noLinkage: "未找到房间关联。",
    targetProfile: "目标",
    linkStatus: "状态",
